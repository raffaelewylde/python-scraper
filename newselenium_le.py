...
def main():
    ...
    for courseurl in ALL_COURSE_URLS:
        print(f"Attempting to navigate to {courseurl}...")
        if x == 0:
            start_button = driver.find_element(By.XPATH, "//div[3]//div[2]//div[3]//div[1]//a[1]//div[1]")
            start_button.click()
            page_actions()
            x = x + 1
        if x == 1:
            start_button = driver.find_element(BY.XPATH, "//div[4]//div[1]//a[1]//div[1]//img[1]")
            start_button.click()
            page_actions()
            x = x + 1
        if x == 2:
            start_button = driver.find_element(BY.XPATH, "//div[5]//div[1]//a[1]//div[1]//img[1]")
            start_button.click()
            page_actions()
            x == x + 1   
